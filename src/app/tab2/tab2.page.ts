...
@Component({
  ...
  imports: [IonHeader, IonToolbar, IonTitle, IonContent, AsyncPipe, IonButton, IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonInput, IonLabel, IonList, IonProgressBar, IonText]
})
